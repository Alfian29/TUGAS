					...
					<div class="tab-content content-profile">
						...
						<div class="tab-pane fade in active" id="myprofile">
							<div class="profile-section">
								...
								<div class="media">
									<div class="media-left">
										<img src="<?=base_url();?>assets/img/user1.jpg" class="user-photo media-object" alt="User">
									</div>
									<div class="media-body">
										<p><b>Motto</b>
											<br> <em>Intelligence is not the determinant of success, but hard work is the real determinant of your success.</em></p>
									</div>
								</div>
							</div>
							<div class="profile-section">
								...
								<div class="clearfix">
									...
									<div class="left">
										...
										<div class="form-group">
											...
											<div>
												<span>29 August 2001</span>
											</div>
										</div>
										<div class="form-group">
											<label>Website</label>
											<div>
												<span>www.muhammadalfian.co.id</span>
											</div>
										</div>
									</div>
									<!-- END LEFT SECTION -->
									...
									<div class="right">
										<div class="form-group">
											<label>Address</label>
											<div>
												<span>JL. Lapangan Gunung Trisno No. 34, Kalibaru 68467</span>
											</div>
										</div>
										<div class="form-group">
											<label>City</label>
								...
								<div class="left">
									<div class="profile-section">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="+6282332320028">
										</div>
										<div class="form-group">
											...
											<select>
												...
												<option value="ina" lang="en">Bahasa Indonesia</option>
										...
										<div class="form-group">
											...
											<select>
												...
												<optgroup label="Manual Offsets">
													...
													<option value="UTC+6">UTC+6</option>
													<option value="UTC+6.5">UTC+6:30</option>
													<option selected="selected" value="UTC+7">UTC+7</option>
													<option value="UTC+7.5">UTC+7:30</option>
													<option value="UTC+8">UTC+8</option>
													<option value="UTC+8.5">UTC+8:30</option>
										...
										<div class="form-group">
											...
											<div class="fancy-radio">
												<label>
													<input name="dateFormat" value="" type="radio" checked><span><i></i>May 10, 2017</span></label>
											</div>
											<div class="fancy-radio">
												<label>
													<input name="dateFormat" value="" type="radio"><span><i></i>2017-05-10</span></label>
											</div>
											<div class="fancy-radio">
												<label>
										...
										<ul class="list-unstyled list-login-session">
											<li>
												<div class="login-session">
													...
													<div class="login-info">
														<h3 class="login-title">Windows 10 - Malang, Indonesia</h3>
											...
											<li>
												<div class="login-session">
													...
													<div class="login-info">
														<h3 class="login-title">Mac - Malang, Indonesia</h3>
														<span class="login-detail">Safari - about an hour ago</span>
													</div>
											...
											<li>
												<div class="login-session">
													...
													<div class="login-info">
														<h3 class="login-title">Android - Malang, Indonesia</h3>
								...
								<div class="right">
									...
									<div class="profile-section">
										...
										<ul class="list-unstyled list-connected-app">
											...
											<li>
												<div class="connected-app">
													<i class="fa fa-amazon app-icon"></i>
													<div class="connection-info">
														<h3 class="app-title">Amazon</h3>
														<span class="actions">
												<a href="#">View Permissions</a> <a href="#">Revoke Access</a>
											</span>
													</div>
