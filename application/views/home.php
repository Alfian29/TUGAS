<div class="dashboard-section">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								<div class="number-chart">
									...
									<div class="number"><span>245</span> <span>Inventories</span></div>
								</div>
							</div>
							<div class="col-md-3 col-sm-6">
								<div class="number-chart">
						...
						<div class="col-md-4">
							...
							<div class="panel-content">
								...
								<ul class="list-unstyled list-referrals">
									<li>
										<p><span class="value">3,014</span><span class="text-muted">visits from Europe</span></p>
										<div class="progress progress-xs progress-transparent custom-color-blue">
											<div class="progress-bar" data-transitiongoal="87"></div>
										</div>
									</li>
									<li>
										<p><span class="value">2,102</span><span class="text-muted">visits from Australia</span></p>
										<div class="progress progress-xs progress-transparent custom-color-purple">
											<div class="progress-bar" data-transitiongoal="34"></div>
										</div>
									</li>
									<li>
										<p><span class="value">2,874</span><span class="text-muted">visits from Asia</span></p>
										<div class="progress progress-xs progress-transparent custom-color-green">
											<div class="progress-bar" data-transitiongoal="67"></div>
										</div>
									</li>
									<li>
										<p><span class="value">2,623</span><span class="text-muted">visits from America</span></p>
				...
				<div class="dashboard-section">
					<div class="section-heading clearfix">
						<h2 class="section-title"><i class="fa fa-shopping-basket"></i> Inventories Summary</h2>
					</div>
					<div class="row">
						<div class="col-md-3">
							<div class="panel-content">
								...
								<ul class="list-unstyled list-justify large-number">
									...
									<li class="clearfix">Inventories <span>47</span></li>
								</ul>
							</div>
						</div>
						<div class="col-md-9">
							<div class="panel-content">
								<h3 class="heading"><i class="fa fa-square"></i> Inventories Performance</h3>
								<div class="row">
									<div class="col-md-6">
										<table class="table">
											<thead>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="panel-content">
								<h3 class="heading"><i class="fa fa-square"></i> Recent Users</h3>
								<div class="table-responsive">
